                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                ...
                                >
                                    <option
                                        v-for="(
                                            crossSellProduct, index
                                        ) in crossSellProducts"
                                        :key="index"
...
export default {
    ...
    data: {
        ...
        upSellProducts: FleetCart.data["up-sell-products"],
        crossSellProducts: FleetCart.data["cross-sell-products"],
        relatedProducts: FleetCart.data["related-products"],
